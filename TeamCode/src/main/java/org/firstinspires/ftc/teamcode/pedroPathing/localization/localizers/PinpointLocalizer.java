...
public class PinpointLocalizer extends Localizer {
    ...
    public PinpointLocalizer(HardwareMap map, Pose setStartPose){
        ...
        odo.setOffsets(203.962, 127); //these are tuned for 3110-0002-0001 Product Insight #1
        //TODO: If you find that the gobilda Yaw Scaling is incorrect you can edit this here Check This
        ...
        odo.setEncoderResolution(1);//need to change
