 ...
 */
public class PinpointLocalizerV2 extends Localizer {
     ...
     */
    public PinpointLocalizerV2(HardwareMap map){ this(map, new Pose());}
     ...
     */
    public PinpointLocalizerV2(HardwareMap map, Pose setStartPose){
        hardwareMap = map;
        ...
        setOffsets(-7.566, -7.25, DistanceUnit.INCH); //these are tuned for 3110-0002-0001 Product Insight #1
